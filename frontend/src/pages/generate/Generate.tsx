...
export default function Generate() {
  ...
  const [variant, setVariant] = useState<
    "filled" | "contained" | "outlined" | "text" | "standard"
  >("outlined");
  // TYPOGRAPHY
    ...
    if (typeSet === "SX") {
      for (let i = 0; i < sxValue.length; i++) {
        if (sxValue[i].use) {
          ...
          newSxOrStyleObj[sxValue[i].name] = checkTypeValueObj(
            sxValue[i].value
          );
        }
      }
      ...
      for (let i = 0; i < styleValue.length; i++) {
        if (styleValue[i].use) {
          ...
          newSxOrStyleObj[styleValue[i].name] = checkTypeValueObj(
            styleValue[i].value
          );
        }
      }
    ...
    if (typeSet === "SX") {
      const defaultNewValue = [
        ...
        },
        {
          ...
          use: false,
          value: "",
          style: [`"linear-gradient(90deg, #FCAF45, #E1306C"`],
        },
        {
          name: "border",
          use: false,
          value: "",
          style: [`"1px solid #ffff00"`],
        },
        {
          name: "borderRadius",
          use: false,
        ...
        },
        {
          ...
          use: false,
          value: "",
          style: [`"underline"`, `"line-through"`],
        },
        {
          name: "textTransform",
          use: false,
          value: "",
          style: [`"none"`, `"uppercase"`, `"capitalize"`],
        },
...
\t${
        ...
        {listTag.map((item: any, index: number) => {
          return (
            <Chip
              ...
              label={
                <Typography
                  sx={{ fontSize: themes.fontsize.small, fontWeight: "bold" }}
                >
                  {item.menu}
                </Typography>
              }
      ...
      return (
        <>
          ...
          {renderItemRowCheckBox(
            ...
            showStartIcon,
            () => {
              setShowStartIcon(!showStartIcon);
            },
            true
          )}
          {renderItemRowCheckBox(
      ...
      return (
        <>
          ...
          {renderItemRowTextField(
            ...
            (e: any) => {
              setRows(
                parseInt(e.target.value) > 10 ? 10 : parseInt(e.target.value)
              );
            },
            false
          )}
      ...
      return (
        <>
          ...
          {renderItemRowCheckBox(
            ...
            showStartAdornment,
            () => {
              setShowStartAdornment(!showStartAdornment);
            },
            true
          )}
          {renderItemRowCheckBox(
            ...
            showEndAdornment,
            () => {
              setShowEndAdornment(!showEndAdornment);
            },
            false
          )}
        </>
  ...
  const renderPopupSetSxOrStyle = () => {
    return (
      <Dialog
        onClose={() => onClosePopupSxOrStyle()}
        open={showSetSxOrStyle}
        aria-labelledby={"popup-set-style"}
        id={"PP_SET_STYLE"}
        fullWidth
        maxWidth="md"
      ...
      >
        ...
        >
          <Grid
            ...
            direction={"column"}
            justifyContent={"center"}
            sx={{ p: `${themes.marginComponent / 2}px` }}
          >
            <Grid
              container
              item
            ...
            {typeValue.map((item: any, index: number) => {
              ...
              return (
                <Grid
                  key={"ITEM_SET_SXORSTYLE_" + item.name.toUpperCase()}
                  container
                  item
                  xs={12}
                  direction={"row"}
                  ...
                  sx={{
                    mb:
                      index !== typeValue.length - 1
                        ? `${themes.marginComponent / 6}px`
                        : 0,
                  }}
                >
                  <Grid
                    ...
                    <FormControlLabel
                      ...
                      control={
                        <Checkbox
                          ...
                          checked={item.use}
                          onChange={() =>
                            onClickSxOrStyleValue(
                              item.name,
                              !item.use,
                              !item.use ? item.style[0] : value,
                              item.style
                            )
                          }
                          inputProps={{ "aria-label": "controlled" }}
                      ...
                      label={
                        <Typography
                          sx={{ fontSize: 13, color: themes.color.mainText }}
                        >
                          {item.name}
                        </Typography>
                      }
...
const listJustifyContent = [
  ...
  {
    menu: "revert-layer",
    key: "DD_ITEM_JUSTIFYCONTENT_10",
    value: "revert-layer",
  },
  { menu: "right", key: "DD_ITEM_JUSTIFYCONTENT_11", value: "right" },
  {
    menu: "space-around",
    key: "DD_ITEM_JUSTIFYCONTENT_12",
    value: "space-around",
  },
  {
    menu: "space-between",
    key: "DD_ITEM_JUSTIFYCONTENT_13",
    value: "space-between",
  },
  {
    menu: "space-evenly",
    key: "DD_ITEM_JUSTIFYCONTENT_14",
    value: "space-evenly",
  },
