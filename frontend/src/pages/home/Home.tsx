...
export default function Home() {
  ...
  const urlGithub =
    "https://github.com/jokersurasit0078/portfoilio-react-surasit";
  ...
  const renderTextProfile = (xs: string, md: string) => {
    return (
      <Grid
        ...
        sx={{
          display: { xs: xs, md: md },
          mt: { xs: `${themes.marginComponent / 2}px`, md: 0 },
        }}
      >
        <Typography
          sx={{
            fontSize: {
              xs: themes.fontsize.large,
              md: themes.fontsize.subHeader,
            },
            fontWeight: "bold",
        ...
        <Grid
          container
          direction={"row"}
          sx={{ mb: `${themes.marginComponent / 4}px` }}
        >
          <Typography
            sx={{
              fontSize: {
        ...
        <Grid
          container
          direction={"row"}
          sx={{ maxWidth: "100%", mb: `${themes.marginComponent / 4}px` }}
        >
        ...
        >
          <Typography
            sx={{
              fontSize: themes.fontsize.small,
              color: themes.color.mainText,
              pr: `${themes.marginComponent / 4}px`,
            }}
          >
    ...
    <Box sx={{ display: "flex", bgcolor: themes.color.bg }}>
      ...
      >
        <Grid
          ...
          justifyContent={"center"}
          alignItems={"center"}
          sx={{ paddingBottom: `${themes.marginComponent}px` }}
        >
          {renderProfile()}
          <Footer />
        </Grid>
