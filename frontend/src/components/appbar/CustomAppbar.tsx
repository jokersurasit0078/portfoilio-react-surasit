...
import iconThai from "../../images/icon_thai.png";
import iconEng from "../../images/icon_eng.png";
    ...
    <div style={{ backgroundColor: themes.color.bg }}>
      <Toolbar sx={{ bgcolor: themes.color.bg }}>
        ...
        >
          ...
          <Typography
            sx={{
              fontSize: themes.fontsize.subHeader,
              fontWeight: "bold",
              pl: "5px",
      ...
      <List>
        {listMenu.map((item: any, index: number) => (
          <ListItem
            key={"MENU_ITEM_MOBILE_" + item.text.toLocaleUpperCase()}
            disablePadding
          >
            <ListItemButton
              sx={{
  ...
  const renderListMenuDrawerForDesktop = (
    <div style={{ backgroundColor: themes.color.bg }}>
      <IconButton
        ...
        aria-label="menu"
        sx={{
          "&:hover": { bgcolor: themes.color.hover },
          width: `${themes.drawerWidth}px`,
      ...
      >
        <Grid
          ...
          alignItems={"center"}
          sx={{
            border: `2px solid ${themes.color.mainText}`,
            width: "35px",
            height: "35px",
            borderRadius: "5px",
          }}
      ...
      <List>
        {listMenu.map((item: any, index: number) => (
          <ListItem
            key={"MENU_ITEM_DESKTOP_" + item.text.toLocaleUpperCase()}
            disablePadding
            sx={{ "&:hover": { bgcolor: themes.color.hover } }}
          >
            <Grid
              container
              direction={"column"}
  ...
  const renderAppbarRightMenu = () => {
    const listItemRightMenu = [
      { text: "English", icon: iconEng, value: window.LIST_LANGUAGES[0].value },
      {
        text: "ภาษาไทย",
        icon: iconThai,
        value: window.LIST_LANGUAGES[1].value,
      },
    ];
    return (
      <>
              ...
              return (
                ...
                >
                  <img
                    ...
                    width={"20px"}
                    height={"20px"}
                    style={{ padding: "2px", paddingRight: "6px" }}
                  />
                  <Typography
                    noWrap
                    style={{
        ...
        >
          ...
          >
            <IconButton
              ...
              aria-haspopup="true"
              onClick={() =>
                handleChangeLanguage(window.LIST_LANGUAGES[0].value)
              }
              color="inherit"
              sx={{
                p: "5px",
            ...
            <IconButton
              ...
              aria-haspopup="true"
              onClick={() =>
                handleChangeLanguage(window.LIST_LANGUAGES[1].value)
              }
              color="inherit"
              sx={{
                p: "5px",
          ...
          <Button
            ...
            startIcon={
              <CustomIcon name={"phone"} color={themes.color.mainText} />
            }
            href={phoneContact}
          >
            {word().TEXT_CALL_ME_NOW}
    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        <Grid
          ...
          justifyContent={"flex-start"}
          alignItems={"center"}
          sx={{ height: themes.appbarHeight, pr: "10px" }}
        >
          <IconButton
            size="large"
            color="inherit"
          ...
          <Grid
            ...
            alignItems={"center"}
            sx={{ width: `calc(100% - ${themes.drawerWidth}px)` }}
          >
            <Grid
              container
              justifyContent={"flex-start"}
